...
from MyTasks.Task16.Controllers.PetController import PetController
...
class PetView(Tk):
    def __init__(self):
        ...
        # Окно ввода данных - типа
        self.input_type = ttk.Entry(self.fram_add)
        self.input_type.pack()

        #age
        self.age = ttk.Label(self.fram_add, text="Введите возрась питомца")
        self.age.pack()

        # Окно ввода данных  - возраста
        ...
        # Окно ввода данных  - имени хозяина питомца
